...
questions = [["which country has the largest area?", "Russia"],
             ...
             ["which country are we in?", "Iran"],
             ["Hitler was the leader of which country?", "Germany"],
             ["The name of the British RAJ is the old name of which country?", "India"],
             ["Which country invented Pizza?", "Italy"],
             ["In which country are there Hiroshima and Nagasaki?", "Japan"]
             ]
